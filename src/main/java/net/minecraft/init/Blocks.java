...
public class Blocks
{
    ...
    public static final BlockSolarPanel SOLAR_PANEL;
    public static final BlockSolarPanel SOLAR_PANEL_INVERTED;
    ...
    static
    {
        ...
        else
        {
            ...
            SOLAR_PANEL = (BlockSolarPanel)getRegisteredBlock("solar_panel");
            SOLAR_PANEL_INVERTED = (BlockSolarPanel)getRegisteredBlock("solar_panel_inverted");
            CACHE.clear();
        }
    }
}